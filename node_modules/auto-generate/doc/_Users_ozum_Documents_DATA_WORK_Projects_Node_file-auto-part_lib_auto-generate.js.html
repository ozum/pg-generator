...
<head>
	<meta charset="utf-8">
	<title>auto-generate Source: /Users/ozum/Documents/DATA/WORK/Projects/Node/file-auto-part/lib/auto-generate.js</title>
...
<div class="container-fluid">
	<div class="navbar navbar-fixed-top navbar-inverse">
		<div class="navbar-inner">
			<a class="brand" href="index.html">auto-generate</a>
			<ul class="nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu ">
						...
						<li>
							<a href="module-auto-generate.html">auto-generate</a>
						</li>
	...
	<div class="row-fluid">
		...
		<h1 class="page-title">Source: /Users/ozum/Documents/DATA/WORK/Projects/Node/file-auto-part/lib/auto-generate.js</h1>
...
function autoStartLine(name) {
    var pre    = Array(Math.floor((60 - name.length) / 2) - 3).join('-');
    var post   = Array(60 - pre.length - name.length).join('-');
...
function autoEndLine(name) {
    var pre    = Array(Math.floor((62 - name.length) / 2) - 3).join('-');
    var post   = Array(62 - pre.length - name.length).join('-');
